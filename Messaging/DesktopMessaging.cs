...
{
    /// <summary>
    /// Desktop messaging that pushes messages via NetMQ to the DesktopServer desktop application, 
    /// heavily based on the <see cref="Messaging"/> class.
    /// </summary>
    public class DesktopMessaging : IMessagingHandler
    {
